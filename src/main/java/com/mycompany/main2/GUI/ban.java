...
import com.mycompany.main2.Project;
import com.mycompany.main2.ProjectAndCommitteeDAO;
...
public void loadData() {
    ...
    for (HelpCase h : list) {
        // بنعرض فقط الصفوف اللي فيها بيانات مشروع إنسان
        if (h.projectType != null || h.homeNeeds != null) {
            Object[] row = {
                h.projectType,       // 1. نوع مشروع
                h.homeNeeds,         // 2. احتياج المنزل
                h.clothingAid,       // 3. الملابس
