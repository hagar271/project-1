...
public class comp extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(comp.class.getName());
    ...
    private void initComponents() {
        ...
        jPanel1.setBounds(0, 0, 1090, 730);
   ...
   jTextField8.setText("");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new comp().setVisible(true));
    }
