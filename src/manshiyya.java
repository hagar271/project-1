...
public class manshiyya extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(manshiyya.class.getName());
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(0, 192, 1100, 400);
   ...
   jTextField8.setText("");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new manshiyya().setVisible(true));
    }
