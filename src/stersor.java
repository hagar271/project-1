...
public class stersor extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(stersor.class.getName());
 ...
 DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
   ...
   jTextField8.setText("");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new stersor().setVisible(true));
    }
