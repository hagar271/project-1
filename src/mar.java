...
public class mar extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(mar.class.getName());
    ...
    private void initComponents() {
        ...
        jPanel2.setBounds(0, 0, 1090, 590);
   ...
   jTextField8.setText("");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new mar().setVisible(true));
    }
